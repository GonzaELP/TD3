...
EXTERN          SEL_CODIGO
EXTERN          SEL_CODIGO_NP3
EXTERN          SEL_DATOS
EXTERN          SEL_DATOS_NP3
...
task1:
    ...
    mov eax,SYS_PRINT; System call de IMPRESION en pantalla
    mov ebx, DEFAULT_ATTRIBUTES ;Atributos de los caracteres
    mov ecx, COUNT_T1_Y ; Fila
    mov edx, 0; Columna
    mov esi, .msg_task1; Mensaje a imprimir
    int 0x80; Llamo a la interrupcion
...
sys_call:
     ...
     cmp eax, SYS_CLRSCR
     je .limpiar_pant
     cmp eax, SYS_GET_SCANCODE
     je .get_scancode
     cmp eax, SYS_SET_SCANCODE
     je .set_scancode
     cmp eax, SYS_ITOA
     je ._itoa
     cmp eax, SYS_HLT
